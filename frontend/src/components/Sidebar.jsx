  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-t border-white/10 space-y-3">
        {!collapsed && (
          <>
            <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-sidebar-hover/50">
              <div className="w-8 h-8 rounded-full bg-tng-blue flex items-center justify-center">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-400 hover:text-white hover:bg-sidebar-hover transition-colors"
            >
        ...
        {collapsed && (
          <div className="space-y-3">
            ...
            <button
              onClick={handleSignOut}
              className="w-full flex justify-center p-2 rounded-lg text-gray-400 hover:text-white hover:bg-sidebar-hover transition-colors"
              title="Sign Out"
            >
              <LogOut className="w-5 h-5" />
            </button>
